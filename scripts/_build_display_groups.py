"""One-shot builder: writes data/universal_display_groups.json from supplier Display lists."""
from __future__ import annotations

import json
from pathlib import Path

OUT = Path(__file__).resolve().parents[1] / "data" / "universal_display_groups.json"
...
add(
    "redmi_32",
    "Redmi",
    "Redmi Note 11s 4G = Redmi Note 11 4G = Redmi Note 12s = Redmi Note 10 4G = Redmi Note 10s 4G = Redmi Note 11 SE 4G = Poco M5s = Redmi Note 11 = Redmi Note 11s = Poco M4 Pro 4G",
)
